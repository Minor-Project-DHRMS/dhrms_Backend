const main = async () => {
  ...
  const getGovD = await mainContract.getGovDetails(deployer.address);
  console.log(getGovD);
  ...
  const getDtxn = await mainContract.getPatentDetails("0x5B38Da6a701c568545dCfcB03FcB875f56beddC4");
  console.log(getDtxn);
